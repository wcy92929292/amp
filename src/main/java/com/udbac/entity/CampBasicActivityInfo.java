 ...
 * @date 2016-05-29
 */
public class CampBasicActivityInfo {
	...
	public String toString() {
		return "CampBasicActivityInfo [createDate=" + createDate + ", activityCode=" + activityCode + ", activityName="
				+ activityName + ", customer=" + customer + ", activityState=" + activityState + ", goLiveType="
				+ goLiveType + ", predictStartDate=" + predictStartDate + ", realityStartDate=" + realityStartDate
				+ ", activityEndDate=" + activityEndDate + ", portPeople=" + portPeople + ", monitorPeople="
				+ monitorPeople + ", frontSupportPeople=" + frontSupportPeople + ", afterSupportPeople="
				+ afterSupportPeople + ", schemeState=" + schemeState + ", updateUser=" + updateUser + ", updateDate="
				+ updateDate + ", schedulePath=" + schedulePath + ", memo=" + memo + ", parentIdf=" + parentIdf
				+ ", parentActivityCode=" + parentActivityCode + ", realName=" + realName + ", countMedia=" + countMedia
				+ ", unit=" + unit + ", getCreateDate()=" + getCreateDate() + ", getActivityCode()=" + getActivityCode()
				+ ", getActivityName()=" + getActivityName() + ", getCustomer()=" + getCustomer()
				+ ", getActivityState()=" + getActivityState() + ", getGoLiveType()=" + getGoLiveType()
				+ ", getPredictStartDate()=" + getPredictStartDate() + ", getRealityStartDate()="
				+ getRealityStartDate() + ", getActivityEndDate()=" + getActivityEndDate() + ", getPortPeople()="
				+ getPortPeople() + ", getMonitorPeople()=" + getMonitorPeople() + ", getFrontSupportPeople()="
				+ getFrontSupportPeople() + ", getAfterSupportPeople()=" + getAfterSupportPeople()
				+ ", getSchemeState()=" + getSchemeState() + ", getUpdateUser()=" + getUpdateUser()
				+ ", getUpdateDate()=" + getUpdateDate() + ", getSchedulePath()=" + getSchedulePath() + ", getMemo()="
				+ getMemo() + ", getParentIdf()=" + getParentIdf() + ", getParentActivityCode()="
				+ getParentActivityCode() + ", getRealName()=" + getRealName() + ", getCountMedia()=" + getCountMedia()
				+ ", getUnit()=" + getUnit() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
