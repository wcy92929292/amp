			...
			function upload(id) {
				...
				if(id == '5') {
					...
					if(file1 != '') {
						...
						$.ajaxFileUpload({
							url: "/amp/admonitor/fileUploadv3.do?date="+$("#sdate_id").val()+'&file=1', //submit to UploadFileServlet  
							secureuri: false,
							fileElementId: 'file1',
							...
							success: function(data, status) {
								if(data == 'success') {
									...
									if(file2 != '') {
										$.ajaxFileUpload({
											url: "/amp/admonitor/fileUploadv3.do?date="+$("#sdate_id").val()+'&file=2', //submit to UploadFileServlet  
											secureuri: false,
											fileElementId: 'file2',
											dataType: 'text', //or json xml whatever you like~  
											success: function(data, status) {
												if(data == 'success') {
													...
													if(file3 != '') {
														$.ajaxFileUpload({
															url: "/amp/admonitor/fileUploadv3.do?date="+$("#sdate_id").val()+'&file=3', //submit to UploadFileServlet  
															secureuri: false,
															fileElementId: 'file3',
															dataType: 'text', //or json xml whatever you like~  
															success: function(data, status) {
																if(data == 'success') {
																	...
																	if(file4 != '') {
																		$.ajaxFileUpload({
																			url: "/amp/admonitor/fileUploadv3.do?date="+$("#sdate_id").val()+'&file=4', //submit to UploadFileServlet  
																			secureuri: false,
																			fileElementId: 'file4',
																			dataType: 'text', //or json xml whatever you like~  
																			success: function(data, status) {
		...
		<div>
			...
			<div class="form_box">
				...
				<div id="month" style="text-align:center;">营销活动访问_pv访次:&emsp;
					<input class="text-input" type="file" id="file3" name="file3" value="" style="margin-left:8px;" onfocus="cleanRate('3');" /> &nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div id="month" style="text-align:center;">营销活动跳出:&emsp;
					<input class="text-input" type="file" id="file4" name="file4" value="" style="margin-left:55px;" onfocus="cleanRate('4');" />&emsp;
