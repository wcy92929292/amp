$(document).ready(function() {
    ...
    $('.sb').click(function(event){
        ...
        // create smoothbox
       $('body').append('<div class="smoothbox sb-load"><div class="smoothbox-table"><div class="smoothbox-centering"><div class="smoothbox-sizing"><div class="sb-nav"><a href="#" id="cl" class="sb-cancel" alt="Close">×</a></div><ul class="sb-items"></ul></div></div></div></div>');
